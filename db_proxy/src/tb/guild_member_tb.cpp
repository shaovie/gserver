...
namespace
{
  ...
  public:
    ...
    {
      int db_sid = -1;
      char bf[sizeof(guild_member_info) + 4];
      stream_istr si(bf, sizeof(bf));

      in_stream is(msg, len);
      is >> db_sid >> si;
      assert(si.str_len() == sizeof(guild_member_info));

      sql_insert *sql = new sql_insert();
      ::memcpy((char *)&sql->data_, si.str(), sizeof(guild_member_info));
  ...
  static tb_msg_maper tm_insert(REQ_INSERT_GUILD_MEMBER, new tb_msg_insert(RES_INSERT_GUILD_MEMBER));
  ...
  static tb_msg_maper tm_delete(REQ_DELETE_GUILD_MEMBER, new tb_msg_delete(RES_DELETE_GUILD_MEMBER));
  ...
  static tb_msg_maper tm_delete_all(REQ_DELETE_GUILD_MEMBERS, new tb_msg_delete_all(RES_DELETE_GUILD_MEMBERS));
  ...
  static tb_msg_maper tm_update(REQ_UPDATE_GUILD_MEMBER, new tb_msg_update(RES_UPDATE_GUILD_MEMBER));
}
