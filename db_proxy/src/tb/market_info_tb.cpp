...
namespace
{
  ...
  static tb_msg_maper tm_insert(REQ_INSERT_MARKET_INFO, new tb_msg_insert(RES_INSERT_MARKET_INFO));
  ...
  public:
    ...
    virtual int handle_msg(proxy_obj *po, const char *msg, const int len)
    {
      ...
      in_stream is(msg, len);
      is >> db_sid >> sql->data_.market_id_;
  ...
  static tb_msg_maper tm_delete(REQ_DELETE_MARKET_INFO, new tb_msg_delete(RES_DELETE_MARKET_INFO));
}
